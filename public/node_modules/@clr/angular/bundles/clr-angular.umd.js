(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Subject'), require('@angular/forms'), require('rxjs/BehaviorSubject'), require('rxjs/operators/map'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Subject', '@angular/forms', 'rxjs/BehaviorSubject', 'rxjs/operators/map', '@angular/animations'], factory) :
	(factory((global.clr = global.clr || {}, global.clr.angular = {}),global.ng.core,global.ng.common,global.Rx,global.ng.forms,global.Rx,global.Rx.Observable.prototype,global.ng.animations));
}(this, (function (exports,core,common,Subject,forms,BehaviorSubject,map,animations) { 'use strict';
 ...
 */
var latestId = 0;
var ClrCheckbox = (function () {
    function ClrCheckbox() {
    ...
    Object.defineProperty(ClrCheckbox.prototype, "id", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(ClrCheckbox.prototype, "checked", {
        /**
         * @return {?}
         */
        get: function () {
    ...
    Object.defineProperty(ClrCheckbox.prototype, "indeterminate", {
        /**
         * @return {?}
         */
        get: function () {
     ...
     * @return {?}
     */
    ClrCheckbox.prototype.setIndeterminate = function (value) {
     ...
     * @return {?}
     */
    ClrCheckbox.prototype.setChecked = function (value) {
        this._checked = value;
     ...
     * @return {?}
     */
    ClrCheckbox.prototype.toggle = function () {
     ...
     * @return {?}
     */
    ClrCheckbox.prototype.writeValue = function (value) {
        if (value === null) {
            value = false;
        }
     ...
     * @return {?}
     */
    ClrCheckbox.prototype.registerOnChange = function (onChange) {
     ...
     * @return {?}
     */
    ClrCheckbox.prototype.registerOnTouched = function (onTouched) {
        this.onTouchedCallback = onTouched;
    };
    /**
     * @return {?}
     */
    ClrCheckbox.prototype.touch = function () {
        this.onTouchedCallback();
    };
    /**
     * @return {?}
     */
    ClrCheckbox.prototype.checkIndeterminateState = function () {
        if (!this.disabled) {
            this.toggle();
        }
    };
...
ClrCheckbox.decorators = [
    { type: core.Component, args: [{
                ...
                /*
                     ...
                     */
                providers: [{ provide: forms.NG_VALUE_ACCESSOR, useExisting: core.forwardRef(function () { return ClrCheckbox; }), multi: true }]
            },] },
];
/** @nocollapse */
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
var CLR_CHECKBOX_DIRECTIVES = [ClrCheckbox];
...
ClrFormsModule.decorators = [
    { type: core.NgModule, args: [{ imports: [common.CommonModule], exports: [ClrCheckboxModule] },] },
];
/** @nocollapse */
...
var ClrDatagridPlaceholder = (function () {
     ...
     * @param {?} page
     */
    function ClrDatagridPlaceholder(items, page) {
        this.items = items;
        this.page = page;
    }
...
var Selection = (function () {
    ...
    function Selection(_items, _filters) {
        ...
        this.subscriptions.push(this._items.allChanges.subscribe(function (updatedItems) {
            ...
            var /** @type {?} */ leftOver = _this.current.slice();
            var /** @type {?} */ newSingle;
            // Calculate the references for each item
            var /** @type {?} */ trackBy = _this._items.trackBy;
            var /** @type {?} */ matched = [];
            updatedItems.forEach(function (item, index) {
                var /** @type {?} */ ref = trackBy(index, item);
                // Look in current selected refs array if item is selected, and update actual value
                if (_this.selectedSingle === ref) {
                    newSingle = item;
                }
                else if (_this.selected.length) {
                    var /** @type {?} */ selectedIndex = _this.selected.indexOf(ref);
                    if (selectedIndex > -1) {
    ...
    Object.defineProperty(Selection.prototype, "currentSingle", {
        ...
        set: function (value) {
            ...
            if (this._items.trackBy && value) {
                var /** @type {?} */ lookup = this._items.displayed.findIndex(function (maybe) { return maybe === value; });
            ...
            case SelectionType.Multi:
                ...
                if (index >= 0 && !selected) {
                    ...
                    if (trackBy) {
                        ...
                        var /** @type {?} */ lookup = this._items.displayed.findIndex(function (maybe) { return maybe === item; });
...
var ClrDatagridColumnToggle = (function () {
     ...
     * @param {?} hideableColumnService
     */
    function ClrDatagridColumnToggle(hideableColumnService) {
        this.hideableColumnService = hideableColumnService;
        /**
         *
         * Popover init
...
var ClrTreeNode = (function (_super) {
     ...
     */
    function ClrTreeNode(nodeExpand, parent, treeSelectionService) {
...
var ClrDropdownItem = (function () {
     ...
     */
    function ClrDropdownItem(dropdown, el, _dropdownService) {
...
var ResponsiveNavigationService = (function () {
    ...
    ResponsiveNavigationService.prototype.sendControlMessage = function (controlCode, navLevel) {
        var /** @type {?} */ message = new ResponsiveNavControlMessage(controlCode, navLevel);
    ...
    ResponsiveNavigationService.prototype.closeAllNavs = function () {
        var /** @type {?} */ message = new ResponsiveNavControlMessage(ResponsiveNavCodes.NAV_CLOSE_ALL, -999);
        this.controlNavSubject.next(message);
    };
...
var ClrMainContainer = (function () {
    ...
    ClrMainContainer.prototype.processMessage = function (message) {
        var /** @type {?} */ navClass = ResponsiveNavCodes.NAV_CLASS_HAMBURGER_MENU;
...
var ClrTabLink = (function () {
    ...
    function ClrTabLink(ifActiveService, id, ariaService, el, cfr, viewContainerRef, tabsId) {
        ...
        var /** @type {?} */ factory = this.cfr.resolveComponentFactory(TemplateRefContainer);
...
var WizardNavigationService = (function () {
    ...
    function WizardNavigationService(pageCollection, buttonService) {
        ...
        this.previousButtonSubscription = this.buttonService.previousBtnClicked.subscribe(function () {
            var /** @type {?} */ currentPage = _this.currentPage;
...
exports.ɵcp = ButtonInGroupService;
...
exports.ɵbm = DatagridDetailRegisterer;
exports.ɵbl = ClrDatagridItemsTrackBy;
...
exports.ɵcr = ResponsiveNavigationProvider;
exports.ɵcq = ResponsiveNavigationService;
exports.ɵdb = ActiveOompaLoompa;
exports.ɵda = TabsWillyWonka;
exports.ɵcv = AriaService;
exports.ɵcz = TabsService;
exports.ɵcw = TABS_ID;
exports.ɵcy = TABS_ID_PROVIDER;
exports.ɵcx = tokenFactory$1;
exports.ɵde = VerticalNavGroupRegistrationService;
exports.ɵdf = VerticalNavGroupService;
exports.ɵdd = VerticalNavIconService;
exports.ɵdc = VerticalNavService;
...
exports.ɵct = TEMPLATE_REF_DIRECTIVES;
exports.ɵcu = TemplateRefContainer;
exports.ɵcs = ClrTemplateRefModule;
exports.ɵdi = ButtonHubService;
exports.ɵdj = HeaderActionService;
exports.ɵdh = PageCollectionService;
exports.ɵdg = WizardNavigationService;
