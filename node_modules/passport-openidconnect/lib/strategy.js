...
Strategy.prototype.authenticate = function(req, options) {
  ...
  console.log("Got these options: " + JSON.stringify(options))
  console.log("Got this req: " + JSON.stringify(req.query.error))
  ...
  console.log("I got this callback: " + callbackURL)
  if (callbackURL) {
    var parsed = url.parse(callbackURL);
    if (!parsed.protocol) {
      // The callback URL is relative, resolve a fully qualified URL from the
      // URL of the originating request.
      console.log("Going to send this: " +utils.originalURL(req) + ", and this: " + callbackURL)
  ...
  if (req.query && req.query.code) {
    ...
    oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: callbackURL }, function(err, accessToken, refreshToken, params) {
      ...
      // The ID Token is now equal to soley: TeamTeam
      self.success(user2, info2);

      // ID Tokens are not returned, yet.
      /*
      ...
      // ID tokens are not returned by Wealth Simple. Yet.
    ...
    */
    ...
    // Jake Edited: cannot have openid by default
    /*
    if (scope) {
    ...
    */
    ...
    console.log("I want to go here: " + location)
