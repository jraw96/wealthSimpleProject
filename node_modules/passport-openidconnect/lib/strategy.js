...
Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    */
    ...
    // Jake note: 
    // This is never called, because the server can't force a redirect on the browser side. 
    // Instead, the redirect url string is sent to the frontend in a json object, and the window is set manually using window.location.href
