...
.btn clr-icon {
  -webkit-transform: translate3d(0rem, -0.08333rem, 0);
...
.btn-sm:not(.btn-link) clr-icon, .alert-app-level .alert-item .btn:not(.btn-link) clr-icon {
  width: 0.5rem;
  height: 0.5rem;
  -webkit-transform: translate3d(0rem, -0.04167rem, 0);
  ...
  .dropdown-menu .dropdown-item {
    ...
    .dropdown-menu .dropdown-item.expandable {
      ...
      .dropdown-menu .dropdown-item.expandable:before {
        ...
        height: 0.5rem;
        width: 0.5rem;
        -webkit-transform: rotate(-90deg) translateX(-0.333rem);
...
.sidenav {
  ...
  .sidenav .collapsible label {
    ...
    .sidenav .collapsible label:after {
      ...
      height: 0.41667rem;
      width: 0.41667rem;
      -webkit-transform: translateX(-0.33333rem) translateY(0.29167rem);
  ...
  .sidenav .collapsible input[type="checkbox"]:checked ~ label:after {
    -webkit-transform: rotate(-90deg) translateX(-0.29167rem) translateY(-0.33333rem);
...
.datagrid-compact .datagrid-foot {
  ...
  padding: 0 0.5rem;
  line-height: calc(1rem - 1px); }
  .datagrid-compact .datagrid-foot .pagination {
